...
public class InventoryUIDetails : MonoBehaviour {
    ...
    Item item;
    Button selectedItemButton, itemInteractButton; //consider changing this to "itemActionButton" to be more consistent with "Action Name" from item properties
    ...
    {
        //assign stuff to the description panel
